...
;(function() {
        ...
        define("cordova/exec", function(require, exports, module) {
                 ...
                 */
                var cordova = require('cordova'), nativeApiProvider = require('cordova/plugin/android/nativeapiprovider'), jsToNativeModes = {
                        PROMPT : 0,
                        JS_OBJECT : 1,
                ...
                nativeToJsBridgeMode = nativeToJsModes.ONLINE_EVENT, pollEnabled = false, messagesFromNative = [];
                ...
                function androidExec(success, fail, service, action, args) {
                        ...
                        var callbackId = service + cordova.callbackId++, argsJson = JSON.stringify(args), returnValue;
        ...
        define("cordova/platform", function(require, exports, module) {
                ...
                module.exports = {
                        id : "android",
                        initialize : function() {
                                var channel = require("cordova/channel"), cordova = require('cordova'), exec = require('cordova/exec');
        ...
        define("cordova/plugin/Camera", function(require, exports, module) {
                ...
                var exec = require('cordova/exec'), Camera = require('cordova/plugin/CameraConstants');
                ...
                cameraExport.getPicture = function(successCallback, errorCallback, options) {
                        ...
                        var args = [quality, destinationType, sourceType, targetWidth, targetHeight, encodingType, mediaType, allowEdit, correctOrientation, saveToPhotoAlbum, popoverOptions];
        ...
        define("cordova/plugin/Contact", function(require, exports, module) {
                ...
                var exec = require('cordova/exec'), ContactError = require('cordova/plugin/ContactError'), utils = require('cordova/utils');
        ...
        define("cordova/plugin/DirectoryEntry", function(require, exports, module) {
                ...
                var utils = require('cordova/utils'), exec = require('cordova/exec'), Entry = require('cordova/plugin/Entry'), FileError = require('cordova/plugin/FileError'), DirectoryReader = require('cordova/plugin/DirectoryReader');
        ...
        define("cordova/plugin/Entry", function(require, exports, module) {
                ...
                var exec = require('cordova/exec'), FileError = require('cordova/plugin/FileError'), Metadata = require('cordova/plugin/Metadata');
        ...
        define("cordova/plugin/FileTransfer", function(require, exports, module) {
                ...
                var exec = require('cordova/exec'), FileTransferError = require('cordova/plugin/FileTransferError'), ProgressEvent = require('cordova/plugin/ProgressEvent');
        ...
        define("cordova/plugin/LocalFileSystem", function(require, exports, module) {
                ...
                //temporary, with no guarantee of persistence
        ...
        define("cordova/plugin/Media", function(require, exports, module) {
                ...
                var utils = require('cordova/utils'), exec = require('cordova/exec');
        ...
        define("cordova/plugin/MediaError", function(require, exports, module) {
                ...
                if (!_MediaError) {
                        window.MediaError = _MediaError = function(code, msg) {
                                ...
                                this.message = msg || "";
                                // message is NON-standard! do not use!
                        };
                }
        ...
        define("cordova/plugin/accelerometer", function(require, exports, module) {
                 ...
                 * @constructor
                 */
                var utils = require("cordova/utils"), exec = require("cordova/exec"), Acceleration = require('cordova/plugin/Acceleration');
        ...
        define("cordova/plugin/compass", function(require, exports, module) {
                ...
                var exec = require('cordova/exec'), utils = require('cordova/utils'), CompassHeading = require('cordova/plugin/CompassHeading'), CompassError = require('cordova/plugin/CompassError'), timers = {}, compass = {
                        /**
        ...
        define("cordova/plugin/contacts", function(require, exports, module) {
                ...
                var exec = require('cordova/exec'), ContactError = require('cordova/plugin/ContactError'), utils = require('cordova/utils'), Contact = require('cordova/plugin/Contact');
        ...
        define("cordova/plugin/device", function(require, exports, module) {
                ...
                var channel = require('cordova/channel'), utils = require('cordova/utils'), exec = require('cordova/exec');
        ...
        define("cordova/plugin/geolocation", function(require, exports, module) {
                ...
                var utils = require('cordova/utils'), exec = require('cordova/exec'), PositionError = require('cordova/plugin/PositionError'), Position = require('cordova/plugin/Position');
        ...
        define("cordova/plugin/globalization", function(require, exports, module) {
                ...
                var exec = require('cordova/exec'), GlobalizationError = require('cordova/plugin/GlobalizationError');
        ...
        define("cordova/plugin/requestFileSystem", function(require, exports, module) {
                ...
                var FileError = require('cordova/plugin/FileError'), FileSystem = require('cordova/plugin/FileSystem'), exec = require('cordova/exec');
        ...
        define("cordova/plugin/resolveLocalFileSystemURI", function(require, exports, module) {
                ...
                var DirectoryEntry = require('cordova/plugin/DirectoryEntry'), FileEntry = require('cordova/plugin/FileEntry'), FileError = require('cordova/plugin/FileError'), exec = require('cordova/exec');
        ...
        ( function(context) {
                        ...
                        var channel = require("cordova/channel"), _self = {
                                boot : function() {
                                        /**
                                         * Create all cordova objects once page has fully loaded and native side is ready.
                                         */
                                        channel.join(function() {
                                                var builder = require('cordova/builder'), base = require('cordova/common'), platform = require('cordova/platform');
